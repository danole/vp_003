...
function style_scripts()
{
    ...
    wp_enqueue_style('lib', get_stylesheet_directory_uri() . '/css/libs.min.css', array());
    wp_enqueue_style('main', get_stylesheet_directory_uri() . '/css/main.css', array());
    wp_enqueue_style('media', get_stylesheet_directory_uri() . '/css/media.css', array());

    wp_enqueue_script('jquery1', 'https://code.jquery.com/jquery-2.2.4.min.js', array(), '2.2.4', true);
    wp_enqueue_script('main', get_stylesheet_directory_uri() . '/js/main.js', array('jquery1'), time(), true);
}
...
function kama_pagenavi($args = array(), $wp_query = null)
{
    ...
    $default = array(
        ...
        'step_link' => 1,           // Ссылки с шагом (если 10, то: 1,2,3...10,20,30. Ставим 0, если такие ссылки не нужны.
        'dotright_text' => '…',          // Промежуточный текст "до".
        'dotright_text2' => '…',          // Промежуточный текст "после".
        'back_text' => '<i class="icon icon-angle-double-left"></i>',    // Текст "перейти на предыдущую страницу". Ставим 0, если эта ссылка не нужна.
        'next_text' => '<i class="icon icon-angle-double-right"></i>',   // Текст "перейти на следующую страницу".  Ставим 0, если эта ссылка не нужна.
